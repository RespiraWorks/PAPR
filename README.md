...
| Item | Quantity | Manufacturer  | Part #              | Price (USD)     |  Sources       | Notes |
| ---- |---------:| ------------- | ------------------- | ------------:|----------------| ----- |
| papr-test1   | 1 | Custom 3D print | 6200SamplingAdapter | $1 (material) | [3D][3d5] | Portacount Sampling Adapter for 6200-series Masks |
| papr-test2   | 1 | Custom 3D print | BayonetFilterTester | $1 (material) | [3D][3d6] | Portacount Sampling Adapter for Bayonet-style Filter Cartridges |
...
[3d9]: https://github.com/RespiraWorks/PAPR/blob/master/release-candidates/PAPRtest/PAPRtest-Portacount-6200SamplingAdapter.stl
[3d10]: https://github.com/RespiraWorks/PAPR/blob/master/release-candidates/PAPRtest/PAPRtest-Portacount-BayonetFilterTester.stl
